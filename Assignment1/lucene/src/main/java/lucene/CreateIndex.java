...
public class CreateIndex {
	...
	//standard list of stop words (Some words were added by checking if they appear more than 15 times)
	public void createIndex(String arg) throws IOException {
		...
		//Standard and English Analyzer
		//Analyzer analyzer = new StandardAnalyzer(stopWordSet); //Score - ((0.2475 - BM25), (0.2536 - Classic similarity (Vector)))
		Analyzer analyzer = new EnglishAnalyzer(stopWordSet); //Score - ((0.2738 -BM25), (0.2722 - Classic similarity (Vector)))
